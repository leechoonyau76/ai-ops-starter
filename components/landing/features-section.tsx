...
const features = [
  {
    number: "01",
    title: "Knowledge lives in many versions",
    description:
      "Policies and SOPs sit in unverified copies across email, drives, and desktops. No one has a single source they trust, so every answer needs re-checking.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Decisions never get logged",
    description:
      "Action items vanish after meetings, so staff re-chase stakeholders who are rarely in the same room — and the same discussion runs twice.",
    visual: "collab",
  },
  {
    number: "03",
    title: "Inputs scatter across tools",
    description:
      "Documents, PDFs, and data live in different places, so staff burn an hour assembling the ingredients before the real work even starts.",
    visual: "ai",
  },
  {
    number: "04",
    title: "Obligations slip, admin debt grows",
    description:
      "Funder and regulator requirements have no clear owner, so compliance becomes a last-minute scramble that compounds each cycle.",
    visual: "security",
  },
];
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24 max-w-3xl">
          ...
          >
            The gaps we see across
            <br />
            <span className="text-muted-foreground">stretched SSAs.</span>
          </h2>
          <p
            className={`mt-6 text-lg text-muted-foreground leading-relaxed transition-all duration-700 delay-100 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
            In programmes, in admin, in finance, in HR — everywhere. None of it
            shows up on a budget line. It shows up the day a trained officer
            burns out and leaves, walking out with years of context you paid to build.
          </p>
        </div>
